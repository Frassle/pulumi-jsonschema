...
namespace Pulumi.Pulumi.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ObjectTypeDetails0
    {
        public readonly ImmutableDictionary<string, object>? AdditionalProperties;
        /// <summary>
        /// A map from property name to propertySpec that describes the object's properties.
        /// </summary>
        public readonly ImmutableDictionary<string, Outputs.PropertyDefinition0>? Properties;
        /// <summary>
        ...
        [OutputConstructor]
        private ObjectTypeDetails0(
            ImmutableDictionary<string, object>? additionalProperties,

            ImmutableDictionary<string, Outputs.PropertyDefinition0>? properties,
