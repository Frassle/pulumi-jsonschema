...
namespace Pulumi.Pulumi.Inputs
{
    ...
    public sealed class OneOf4Args : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.OutputsPropertiesAdditionalPropertiesArgs>? _oneOf;

        /// <summary>
        /// If present, indicates that values of the type may be one of any of the listed types
        /// </summary>
        public InputList<Inputs.OutputsPropertiesAdditionalPropertiesArgs> OneOf
        {
            get => _oneOf ?? (_oneOf = new InputList<Inputs.OutputsPropertiesAdditionalPropertiesArgs>());
            set => _oneOf = value;
        }
