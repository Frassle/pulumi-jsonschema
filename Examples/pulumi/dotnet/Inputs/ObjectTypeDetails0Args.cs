...
namespace Pulumi.Pulumi.Inputs
{
    ...
    /// </summary>
    public sealed class ObjectTypeDetails0Args : global::Pulumi.ResourceArgs
    {
        ...
        [Input("properties")]
        private InputMap<Inputs.PropertyDefinition3Args>? _properties;

        /// <summary>
        /// A map from property name to propertySpec that describes the object's properties.
        /// </summary>
        public InputMap<Inputs.PropertyDefinition3Args> Properties
        {
            get => _properties ?? (_properties = new InputMap<Inputs.PropertyDefinition3Args>());
        ...
        public ObjectTypeDetails0Args()
        {
        }
        public static new ObjectTypeDetails0Args Empty => new ObjectTypeDetails0Args();
    }
}
