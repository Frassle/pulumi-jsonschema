...
namespace Pulumi.Pulumi.Inputs
{
    ...
    public sealed class ResourceDefinition0Args : global::Pulumi.ResourceArgs
    {
        ...
        private InputMap<Inputs.PropertyDefinition2Args>? _inputProperties;

        /// <summary>
        /// A map from property name to propertySpec that describes the resource's input properties.
        /// </summary>
        public InputMap<Inputs.PropertyDefinition2Args> InputProperties
        {
            get => _inputProperties ?? (_inputProperties = new InputMap<Inputs.PropertyDefinition2Args>());
        ...
        [Input("properties")]
        private InputMap<Inputs.PropertyDefinition4Args>? _properties;

        /// <summary>
        /// A map from property name to propertySpec that describes the object's properties.
        /// </summary>
        public InputMap<Inputs.PropertyDefinition4Args> Properties
        {
            get => _properties ?? (_properties = new InputMap<Inputs.PropertyDefinition4Args>());
