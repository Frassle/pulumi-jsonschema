...
namespace Pulumi.Pulumi.Inputs
{
    ...
    /// </summary>
    public sealed class PropertyDefinition5Args : global::Pulumi.ResourceArgs
    {
        ...
        [Input("choice1Of5")]
        public Input<Inputs.PrimitiveTypeArgs>? Choice1Of5 { get; set; }

        [Input("choice2Of5")]
        public Input<Inputs.ArrayType3Args>? Choice2Of5 { get; set; }

        [Input("choice3Of5")]
        public Input<Inputs.MapType4Args>? Choice3Of5 { get; set; }

        [Input("choice4Of5")]
        public Input<Inputs.NamedType3Args>? Choice4Of5 { get; set; }
        ...
        [Input("defaultInfo")]
        public Input<Inputs.ResourcesAdditionalPropertiesPropertiesAdditionalPropertiesDefaultInfoArgs>? DefaultInfo { get; set; }
        ...
        public PropertyDefinition5Args()
        {
        }
        public static new PropertyDefinition5Args Empty => new PropertyDefinition5Args();
    }
}
