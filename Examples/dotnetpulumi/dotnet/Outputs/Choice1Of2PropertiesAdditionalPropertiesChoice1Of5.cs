...
namespace Pulumi.Pulumi.Outputs
{
    ...
    /// </summary>
    [OutputType]
    public sealed class Choice1Of2PropertiesAdditionalPropertiesChoice1Of5
    {
        public readonly Pulumi.Pulumi.TypeSpecOneOf0PropertiesType Type;

        [OutputConstructor]
        private Choice1Of2PropertiesAdditionalPropertiesChoice1Of5(Pulumi.Pulumi.TypeSpecOneOf0PropertiesType type)
        {
            Type = type;
        }
    }
