...
namespace Pulumi.GithubWorkflow
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.GithubWorkflow.version.txt");
    ...
    internal sealed class GithubWorkflowResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public GithubWorkflowResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
