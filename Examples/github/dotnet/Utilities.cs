...
namespace Pulumi.Jsonschema
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Jsonschema.version.txt");
    ...
    internal sealed class JsonschemaResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public JsonschemaResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
