...
namespace Pulumi.Pulumi.Inputs
{
    ...
    /// </summary>
    public sealed class PropertiesAdditionalPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("choice1Of5")]
        public Inputs.Choice1Of5Args? Choice1Of5 { get; set; }

        [Input("choice2Of5")]
        public Inputs.Choice2Of5Args? Choice2Of5 { get; set; }

        [Input("choice3Of5")]
        public Inputs.Choice3Of5Args? Choice3Of5 { get; set; }

        [Input("choice4Of5")]
        public Inputs.NamedTypeArgs? Choice4Of5 { get; set; }

        [Input("choice5Of5")]
        public Inputs.Choice5Of5Args? Choice5Of5 { get; set; }
        ...
        public PropertiesAdditionalPropertiesArgs()
        {
        }
        public static new PropertiesAdditionalPropertiesArgs Empty => new PropertiesAdditionalPropertiesArgs();
    }
}
