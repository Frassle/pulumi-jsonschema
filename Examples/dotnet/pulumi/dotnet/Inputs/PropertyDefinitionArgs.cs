...
namespace Pulumi.Pulumi.Inputs
{
    ...
    public sealed class PropertyDefinitionArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("choice1Of5")]
        public Inputs.PrimitiveTypeArgs? Choice1Of5 { get; set; }

        [Input("choice2Of5")]
        public Inputs.ArrayTypeArgs? Choice2Of5 { get; set; }

        [Input("choice3Of5")]
        public Inputs.MapTypeArgs? Choice3Of5 { get; set; }

        [Input("choice4Of5")]
        public Inputs.NamedTypeArgs? Choice4Of5 { get; set; }

        [Input("choice5Of5")]
        public Inputs.UnionTypeArgs? Choice5Of5 { get; set; }
