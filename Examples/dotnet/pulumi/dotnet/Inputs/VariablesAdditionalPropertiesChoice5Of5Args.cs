...
namespace Pulumi.Pulumi.Inputs
{
    ...
    public sealed class VariablesAdditionalPropertiesChoice5Of5Args : global::Pulumi.ResourceArgs
    {
        ...
        private List<Inputs.VariablesAdditionalPropertiesArgs>? _oneOf;

        /// <summary>
        /// If present, indicates that values of the type may be one of any of the listed types
        /// </summary>
        public List<Inputs.VariablesAdditionalPropertiesArgs> OneOf
        {
            get => _oneOf ?? (_oneOf = new List<Inputs.VariablesAdditionalPropertiesArgs>());
            set => _oneOf = value;
        }
