...
namespace Pulumi.Pulumi.Inputs
{
    ...
    /// </summary>
    public sealed class VariablesAdditionalPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("choice1Of5")]
        public Inputs.VariablesAdditionalPropertiesChoice1Of5Args? Choice1Of5 { get; set; }

        [Input("choice2Of5")]
        public Inputs.VariablesAdditionalPropertiesChoice2Of5Args? Choice2Of5 { get; set; }

        [Input("choice3Of5")]
        public Inputs.VariablesAdditionalPropertiesChoice3Of5Args? Choice3Of5 { get; set; }

        [Input("choice4Of5")]
        public Inputs.NamedTypeArgs? Choice4Of5 { get; set; }

        [Input("choice5Of5")]
        public Inputs.VariablesAdditionalPropertiesChoice5Of5Args? Choice5Of5 { get; set; }
        ...
        public VariablesAdditionalPropertiesArgs()
        {
        }
        public static new VariablesAdditionalPropertiesArgs Empty => new VariablesAdditionalPropertiesArgs();
    }
}
