...
namespace Pulumi.Pulumi.Inputs
{
    ...
    public sealed class InputsPropertiesAdditionalPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("choice1Of5")]
        public Inputs.AdditionalPropertiesChoice1Of5Args? Choice1Of5 { get; set; }

        [Input("choice2Of5")]
        public Inputs.AdditionalPropertiesChoice2Of5Args? Choice2Of5 { get; set; }

        [Input("choice3Of5")]
        public Inputs.AdditionalPropertiesChoice3Of5Args? Choice3Of5 { get; set; }

        [Input("choice4Of5")]
        public Inputs.NamedTypeArgs? Choice4Of5 { get; set; }

        [Input("choice5Of5")]
        public Inputs.AdditionalPropertiesChoice5Of5Args? Choice5Of5 { get; set; }
