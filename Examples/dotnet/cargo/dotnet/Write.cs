...
namespace Pulumi.Cargo
{
    public static class Write
    {
        ...
        public static Task<WriteResult> InvokeAsync(WriteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<WriteResult>("cargo:index:write", args ?? new WriteArgs(), options.WithDefaults(), Utilities.PackageParameterization());

        /// <summary>
        /// Read the given JSON into the object model
        /// </summary>
        public static Output<WriteResult> Invoke(WriteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<WriteResult>("cargo:index:write", args ?? new WriteInvokeArgs(), options.WithDefaults());
    }
