...
namespace Pulumi.Cargo.Inputs
{
    ...
    public sealed class DevArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("buildOverride")]
        public Inputs.DevArgs? BuildOverride { get; set; }
        ...
        [Input("package")]
        private Dictionary<string, Inputs.DevArgs>? _package;
        ...
        /// </summary>
        public Dictionary<string, Inputs.DevArgs> Package
        {
            get => _package ?? (_package = new Dictionary<string, Inputs.DevArgs>());
            set => _package = value;
        }

        [Input("panic")]
        public Pulumi.Cargo.DevPanic? Panic { get; set; }
        ...
        public static new DevArgs Empty => new DevArgs();
    }
}
