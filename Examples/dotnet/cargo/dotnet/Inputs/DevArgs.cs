...
namespace Pulumi.Cargo.Inputs
{
    ...
    public sealed class DevArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("buildOverride")]
        public Input<Inputs.DevArgs>? BuildOverride { get; set; }
        ...
        [Input("package")]
        private InputMap<Inputs.DevArgs>? _package;
        ...
        /// </summary>
        public InputMap<Inputs.DevArgs> Package
        {
            get => _package ?? (_package = new InputMap<Inputs.DevArgs>());
            set => _package = value;
        }

        [Input("panic")]
        public Input<Pulumi.Cargo.DevPanic>? Panic { get; set; }
