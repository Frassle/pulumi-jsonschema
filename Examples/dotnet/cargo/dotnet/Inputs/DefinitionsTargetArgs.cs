...
namespace Pulumi.Cargo.Inputs
{
    ...
    /// ```
    /// </summary>
    public sealed class DefinitionsTargetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("edition")]
        public Input<Pulumi.Cargo.DefinitionsEdition>? Edition { get; set; }
        ...
        public DefinitionsTargetArgs()
        {
        }
        public static new DefinitionsTargetArgs Empty => new DefinitionsTargetArgs();
    }
}
