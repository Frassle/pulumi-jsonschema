...
namespace Pulumi.Cargo.Inputs
{
    ...
    public sealed class Test : global::Pulumi.InvokeArgs
    {
        ...
        [Input("buildOverride")]
        public Inputs.Test? BuildOverride { get; set; }
        ...
        [Input("package")]
        private Dictionary<string, Inputs.Test>? _package;
        ...
        /// </summary>
        public Dictionary<string, Inputs.Test> Package
        {
            get => _package ?? (_package = new Dictionary<string, Inputs.Test>());
            set => _package = value;
        }
        ...
        public static new Test Empty => new Test();
    }
}
