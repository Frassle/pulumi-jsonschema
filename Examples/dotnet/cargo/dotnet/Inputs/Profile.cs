...
namespace Pulumi.Cargo.Inputs
{
    ...
    public sealed class Profile : global::Pulumi.InvokeArgs
    {
        ...
        [Input("buildOverride")]
        public Inputs.Profile? BuildOverride { get; set; }
        ...
        [Input("package")]
        private Dictionary<string, Inputs.Profile>? _package;
        ...
        /// </summary>
        public Dictionary<string, Inputs.Profile> Package
        {
            get => _package ?? (_package = new Dictionary<string, Inputs.Profile>());
            set => _package = value;
        }
        ...
        /// </summary>
        [Input("panic")]
        public Pulumi.Cargo.Panic? Panic { get; set; }
        ...
        public static new Profile Empty => new Profile();
    }
}
