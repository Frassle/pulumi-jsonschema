...
namespace Pulumi.Cargo.Inputs
{
    ...
    public sealed class DefinitionsProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("buildOverride")]
        public Inputs.DefinitionsProfileArgs? BuildOverride { get; set; }
        ...
        [Input("package")]
        private Dictionary<string, Inputs.DefinitionsProfileArgs>? _package;
        ...
        /// </summary>
        public Dictionary<string, Inputs.DefinitionsProfileArgs> Package
        {
            get => _package ?? (_package = new Dictionary<string, Inputs.DefinitionsProfileArgs>());
            set => _package = value;
        }

        [Input("panic")]
        public Pulumi.Cargo.DefinitionsPanic? Panic { get; set; }
        ...
        public DefinitionsProfileArgs()
        {
        }
        public static new DefinitionsProfileArgs Empty => new DefinitionsProfileArgs();
    }
}
