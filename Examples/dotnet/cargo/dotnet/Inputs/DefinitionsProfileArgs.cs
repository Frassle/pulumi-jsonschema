...
namespace Pulumi.Cargo.Inputs
{
    ...
    public sealed class DefinitionsProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("buildOverride")]
        public Input<Inputs.DefinitionsProfileArgs>? BuildOverride { get; set; }
        ...
        [Input("package")]
        private InputMap<Inputs.DefinitionsProfileArgs>? _package;
        ...
        /// </summary>
        public InputMap<Inputs.DefinitionsProfileArgs> Package
        {
            get => _package ?? (_package = new InputMap<Inputs.DefinitionsProfileArgs>());
            set => _package = value;
        }

        [Input("panic")]
        public Input<Pulumi.Cargo.DefinitionsPanic>? Panic { get; set; }
