...
namespace Pulumi.Cargo.Inputs
{
    ...
    public sealed class DefinitionsProfile : global::Pulumi.InvokeArgs
    {
        ...
        [Input("buildOverride")]
        public Inputs.DefinitionsProfile? BuildOverride { get; set; }
        ...
        [Input("package")]
        private Dictionary<string, Inputs.DefinitionsProfile>? _package;
        ...
        /// </summary>
        public Dictionary<string, Inputs.DefinitionsProfile> Package
        {
            get => _package ?? (_package = new Dictionary<string, Inputs.DefinitionsProfile>());
            set => _package = value;
        }
        ...
        public static new DefinitionsProfile Empty => new DefinitionsProfile();
    }
}
