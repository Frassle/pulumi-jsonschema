...
namespace Pulumi.Cargo.Inputs
{
    ...
    public sealed class Dev : global::Pulumi.InvokeArgs
    {
        ...
        [Input("buildOverride")]
        public Inputs.Dev? BuildOverride { get; set; }
        ...
        [Input("package")]
        private Dictionary<string, Inputs.Dev>? _package;
        ...
        /// </summary>
        public Dictionary<string, Inputs.Dev> Package
        {
            get => _package ?? (_package = new Dictionary<string, Inputs.Dev>());
            set => _package = value;
        }
        ...
        public static new Dev Empty => new Dev();
    }
}
