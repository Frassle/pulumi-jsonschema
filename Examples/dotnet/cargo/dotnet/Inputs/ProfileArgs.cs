...
namespace Pulumi.Cargo.Inputs
{
    ...
    public sealed class ProfileArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("buildOverride")]
        public Inputs.ProfileArgs? BuildOverride { get; set; }
        ...
        [Input("package")]
        private Dictionary<string, Inputs.ProfileArgs>? _package;
        ...
        /// </summary>
        public Dictionary<string, Inputs.ProfileArgs> Package
        {
            get => _package ?? (_package = new Dictionary<string, Inputs.ProfileArgs>());
            set => _package = value;
        }
