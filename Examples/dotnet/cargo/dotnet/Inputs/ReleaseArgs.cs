...
namespace Pulumi.Cargo.Inputs
{
    ...
    public sealed class ReleaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("buildOverride")]
        public Inputs.ReleaseArgs? BuildOverride { get; set; }
        ...
        [Input("package")]
        private Dictionary<string, Inputs.ReleaseArgs>? _package;
        ...
        /// </summary>
        public Dictionary<string, Inputs.ReleaseArgs> Package
        {
            get => _package ?? (_package = new Dictionary<string, Inputs.ReleaseArgs>());
            set => _package = value;
        }
