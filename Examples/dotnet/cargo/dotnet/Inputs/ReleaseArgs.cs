...
namespace Pulumi.Cargo.Inputs
{
    ...
    public sealed class ReleaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("buildOverride")]
        public Input<Inputs.ReleaseArgs>? BuildOverride { get; set; }
        ...
        [Input("package")]
        private InputMap<Inputs.ReleaseArgs>? _package;
        ...
        /// </summary>
        public InputMap<Inputs.ReleaseArgs> Package
        {
            get => _package ?? (_package = new InputMap<Inputs.ReleaseArgs>());
            set => _package = value;
        }

        [Input("panic")]
        public Input<Pulumi.Cargo.ReleasePanic>? Panic { get; set; }
