...
namespace Pulumi.Cargo.Inputs
{
    ...
    /// </summary>
    public sealed class ItemsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("edition")]
        public Input<Pulumi.Cargo.ItemsEdition>? Edition { get; set; }
        ...
        public static new ItemsArgs Empty => new ItemsArgs();
    }
}
