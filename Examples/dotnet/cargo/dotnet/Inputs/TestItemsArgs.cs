...
namespace Pulumi.Cargo.Inputs
{
    ...
    /// executable.
    /// </summary>
    public sealed class TestItemsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("edition")]
        public Input<Pulumi.Cargo.TestItemsEdition>? Edition { get; set; }
        ...
        public TestItemsArgs()
        {
        }
        public static new TestItemsArgs Empty => new TestItemsArgs();
    }
}
