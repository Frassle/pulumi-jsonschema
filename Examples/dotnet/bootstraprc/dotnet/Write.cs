...
namespace Pulumi.Bootstraprc
{
    public static class Write
    {
        ...
        public static Task<WriteResult> InvokeAsync(WriteArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<WriteResult>("bootstraprc:index:write", args ?? new WriteArgs(), options.WithDefaults(), Utilities.PackageParameterization());

        /// <summary>
        /// Read the given JSON into the object model
        /// </summary>
        public static Output<WriteResult> Invoke(WriteInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<WriteResult>("bootstraprc:index:write", args ?? new WriteInvokeArgs(), options.WithDefaults());
    }
    ...
    public sealed class WriteArgs : global::Pulumi.InvokeArgs
    {
        ...
        public Inputs.CoreProperties Value { get; set; } = null!;
    ...
    {
        [Input("value", required: true)]
        public Input<Inputs.CorePropertiesArgs> Value { get; set; } = null!;
