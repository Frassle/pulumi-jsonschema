...
let arrayTestCases : obj array list = [
    [| TypeReference.Primitive PrimitiveType.String; """{ "type": "array", "items": { "type": "string" } }""" |]
    [| TypeReference.Array (TypeReference.Primitive PrimitiveType.Integer); """{ "type": "array", "items": { "type": "array", "items": { "type": "integer" } } }""" |]
]
[<Theory>]
...
let mapTestCases : obj array list = [
    [| TypeReference.Primitive PrimitiveType.String; """{ "type": "object", "additionalProperties": { "type": "string" } }""" |]
    [| TypeReference.Array (TypeReference.Primitive PrimitiveType.Integer); """{ "type": "object", "additionalProperties": { "type": "array", "items": { "type": "integer" } } }""" |]
]
[<Theory>]
